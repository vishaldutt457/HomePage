    ...
    return (
        <div className="footerLeft">
                ...
                <div className="footerLeft_Chat">
                    <div className="chats">
                        <div className="chats_text">
                        <h4>Nah! I dunno. Play soccer.. or learn more coding perghaps?</h4>
                        <div className="time2">
                ...
                <button className="footer_btn">Full Converastions</button>
                <hr/>
